...
class MedicoModelo {
    constructor(nombres, espacialidad, telefono, correo, direccion) {
    ...
    async save() {
        const query = `
            INSERT INTO medico (nombres, espacialidad, telefono, correo, direccion)
            VALUES ($1, $2, $3, $4, $5)
            RETURNING idmedico
        `;
        const values = [this.nombres, this.espacialidad, this.telefono, this.correo, this.direccion];
        try {
